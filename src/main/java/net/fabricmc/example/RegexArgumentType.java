...
public class RegexArgumentType implements ArgumentType<String> {
	...
	public static final SimpleCommandExceptionType DOES_NOT_MATCH_REGEX_EXCEPTION = new SimpleCommandExceptionType(new LiteralText("This doesn't match the regex!"));
